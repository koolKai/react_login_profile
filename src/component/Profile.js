        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4 profile-image">
              <div class="card mb-5" style={{ border: "none" }}>
                <div class="card-body text-center">
                  ...
                  <h5 class="my-3">{name ? name : "Name"}</h5>
                  <p class="text-muted mb-1">{title ? title : "Job Title"}</p>
            ...
            <div class="col-lg-8">
              ...
              <div
                class="item d-flex justify-content-around align-items-center"
                style={{ border: "none" }}
              >
